 ...
 * @author bensa
 */
public class IndexFrontCompanyController implements Initializable {
   ...
   private void load_event(ActionEvent event) throws IOException {
        ...
        try {
            Pane newLoadedPane;
            // TODO
            newLoadedPane = FXMLLoader.load(getClass().getResource("AfficherEvenement.fxml"));
  ...
  private void load_article(ActionEvent event) {
        ...
        try {
            Pane newLoadedPane;
            // TODO
            newLoadedPane = FXMLLoader.load(getClass().getResource("AfficherArticle.fxml"));
            list_tab.getChildren().add(newLoadedPane);
        } catch (IOException ex) {
            Logger.getLogger(IndexController.class.getName()).log(Level.SEVERE, null, ex);
        }
