...
import com.netdev.mindspace.entites.Post;

import com.netdev.mindspace.services.ServicePost;
 ...
 * @author bhk
 */
public class ListPostsForm extends BaseForm{
Form current;
    public ListPostsForm(Resources res) {
    ...
    Image img = res.getImage("mobile.jpg");
 ...
 /////////
       ...
       swipe.setUIID("Container");
        ...
        //list of posts
         ...
         for(Post p : list){
             String urlImage = "mobile.jpg.jpg";
    ...
    private void addButton(Image img,String dt, String content, int like, Post p, Resources res ) {
