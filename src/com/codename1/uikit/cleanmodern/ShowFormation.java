...
//
//import com.codename1.uikit.cleanmodern.ListFormation;
...
//        addButton(urlim, j.getNomformation(), j.getSujetdeformation(), j.getNbrParticipants(), j);
//
//        Button postuler = new Button("Apply");
//        postuler.addActionListener(l->{
//            sendMail(j.getAddress())
...
//            String salaire, String niveau, String date, String category,String address, Job j) {
//
...
//        
//        
////          User u = UserService.getInstance().getUser1(user_id);
...
//                c, lContrat, l, lNiveau, s, lSalaire, d, lDate, cat, lCat,l1,l11));
//        add(cnt);
//
//    }
//    
